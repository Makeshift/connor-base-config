...
declare namespace convict {
    ...
    interface Config<T> {
        ...
        /**
         * Replaces the current schema with the given schema, adding the current properties on top
         * @returns {convict.Config<T>}
         */
        updateSchema(obj: SchemaObj, validate?: boolean): SchemaObj<T>;

        /**
         * Merges the current schema with the given schema, adding the current properties on top
         * @returns {convict.Config<T>}
         */
        addToschema(obj: SchemaObj, validate?: boolean): SchemaObj<T>;
    }
}
